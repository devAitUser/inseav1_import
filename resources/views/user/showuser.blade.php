...
<div style="background-color: #2b7239" class="panel-heading"> 
               ...
               <div class="card-body ">
                  <form method="POST" action="{{ route('updateUser',$user->id) }}">
                     ...
                     <div class="row mb-5 pt-3">
                        ...
                        <div class="col-md-6">
                           <button style="background-color: #2b7239" type="submit" class="btn btn-primary " >
                  ...
                  <div class="card-body">
                     ...
                     <form method="POST" action="{{ route('assignRole',$user->id) }}">
                        ...
                        <div class="container btn_role_bottom" >
                           <div class="row">
                              <button style="background-color: #2b7239" type="submit" class="btn btn-primary ml-4">
                                 Mettre à jour le rôle
                              </button>
                              &nbsp;
                              <button style="background-color: #2b7239" type="reset" class="btn btn-primary" >
                              {{ __('Annuler') }}
                              </button>
                           </div>
                        </div>
